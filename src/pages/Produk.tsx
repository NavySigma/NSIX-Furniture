...
export default function Produk() {
  ...
  const igUrl =
    "https://www.instagram.com/p/DXqnougArS3/?utm_source=ig_web_copy_link&igsh=NTc4MTIwNjQ2YQ==";

  return (
    <main className="page-produk">
      <Helmet>
        <link rel="canonical" href="https://www.nsix.web.id/" />
        <title>NSIX Furniture Creation - Custom Furniture Malang</title>
      </Helmet>
            ...
            {filtered.map((p, i) => {
              ...
              return (
                <div key={i} className="produk-card">
                  <div
                    className={`produk-card-img ${isSelected ? "selected" : ""}`}
                  ...
                  >
                    ...
                    <div
                      className={`produk-card-overlay ${isSelected ? "visible" : ""}`}
                    >
                      <button
                        className="produk-card-close"
                        onClick={(e) => {
                          e.stopPropagation();
                          setSelectedImg(null);
                        }}
                      ...
                      <a
                        ...
                        className="produk-card-overlay-btn"
                  ...
                  <div className="produk-card-body">
                    ...
                    <a
                      href={waUrl(
                        `saya tertarik dengan produk: *${p.nama}*`,
      ...
      <section className="dash-cta section">
        <div className="container">
          <SectionTitle subtitle="Hubungi Kami">Konsultasi Gratis</SectionTitle>
          <div className="dash-cta-content">
            <p>
              Punya rencana untuk furniture impian? Diskusikan bersama tim NSIX
              Furniture. Gratis, tanpa biaya!
            </p>
            <a
              href={waUrl()}
              target="_blank"
